...
name = "algoagents-client"
author = "Viktor Kerkez"
author_email = "alefnula@gmail.com"
url = "https://github.com/algoagents/algoagents-client"


def get_version():
    """Import the version module and get the project version from it."""
    version_py = Path(__file__).parent / "algoagents" / "version.py"
...
setup(
    ...
    description="Python client for algoagents.com API.",
