# algoagents.com API client

This is a client for [PapersWithCode](https://algoagents.com/api/v1/docs/)
read/write API.
...
[ReadTheDocs](https://algoagents-client.readthedocs.io/en/latest/) website.

It is published to the
[Python Package Index](https://pypi.org/project/algoagents-client/) and
can be installed by simply calling `pip install algoagents-client`.
...
from algoagents import PapersWithCodeClient
...
For full docs please see our [ReadTheDocs](https://algoagents-client.readthedocs.io/en/latest/) page.
...
To use the API in the write mode you'll need to first [obtain an API token](https://algoagents.com/accounts/generate_api_token).
...
new task on the [Task addition page](https://algoagents.com/add/task). 
...
You can then access it by going to `https://algoagents.com/sota/<your_leaderboard_id>` or find it using 
the site search.  
...
For in-depth API docs please refer to our [ReadTheDocs](https://algoagents-client.readthedocs.io/en/latest/) page.
...
If you need any help contact us on hello@algoagents.com. 
